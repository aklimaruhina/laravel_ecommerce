                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="10" required autocomplete="address" autofocus>{{ old('address') }}</textarea>
                        ...
                        <!-- End Address -->
                        <!-- Add Division From the Drop Down List -->
                        <div class="form-group row">
