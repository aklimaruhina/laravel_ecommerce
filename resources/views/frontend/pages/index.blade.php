  ...
  <div class="container">
        <div class="mainbanner">
            <div id="main-banner" class="owl-carousel home-slider">
                <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner-1.png')}}" alt="main-banner1" class="img-responsive" /></a> </div>
                <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner-2.png')}}" alt="main-banner2" class="img-responsive" /></a> </div>
                <div class="item"> <a href="#"><img src="{{asset('image/banner-img/banner-3.png')}}" alt="main-banner3" class="img-responsive" /></a> </div>
            </div>
        </div>
    </div>
                ...
                <div class="product-thumb transition">
                  <div class="image product-imageblock">
                    <a href="{{ route('show_product', $product->slug )}}"> 
                      ...
                      @if($i > 0)
                      <img src="{{ asset('image/product-image/' . $image->image ) }}" alt="{{ $product->title }}" title="{{ $product->title}}" class="img-responsive" /> 
                      @endif
                      @php 
                      $i--;
                      @endphp
                  ...
                  <div class="caption product-detail">
                    <h4 class="product-name"><a href="#" title="lorem ippsum dolor dummy">{{ $product->title }}</a></h4>
